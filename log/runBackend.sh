...
# @Last Modified time: 2013-11-20 14:02:23
host=$1
it=$2
i=$3
...
ssh $host -o 'StrictHostKeyChecking no' -o 'UserKnownHostsFile /dev/null' "java -cp ~/sparrow/target/sparrow-1.0-SNAPSHOT.jar edu.berkeley.sparrow.examples.SimpleBackend > /tmp/job.back.$it.$i.out"
