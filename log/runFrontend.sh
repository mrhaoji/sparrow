...
# @Last Modified time: 2013-11-19 19:37:39
host=$1
it=$2
i=$3
...
ssh $host -o 'StrictHostKeyChecking no' -o 'UserKnownHostsFile /dev/null' "java -cp ~/sparrow/target/sparrow-1.0-SNAPSHOT.jar edu.berkeley.sparrow.examples.SimpleFrontend -c ~/sparrow/frontend.conf  > ~/sparrow/log/job.front.$it.$i.out"