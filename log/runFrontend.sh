...
# @Last Modified time: 2013-11-18 14:34:18
host=$1
i=$2
...
ssh $host -o 'StrictHostKeyChecking no' -o 'UserKnownHostsFile /dev/null' "java -cp ~/sparrow/target/sparrow-1.0-SNAPSHOT.jar edu.berkeley.sparrow.examples.SimpleFrontend -c ~/sparrow/frontend.conf  > ~/sparrow/log/job.$host.$i.out"